...
data['Metallica']['inDegreeAvg'] = sum/count
...
data['Metallica']['outDegreeAvg'] = sum/count
...
data['Metallica']['degreeAvg'] = sum/count
...
data['Metallica']['avgDegreeConn'] = sum/count
...
data['Metallica']['avgNeighborDeg'] = sum/count

print "\navg shortest path length generated"
data['Metallica']['avgShortPathLen'] = nx.average_shortest_path_length(G)
